...
@kopf.on.update("", "v1", "configmaps", labels={"app.kubernetes.io/managed-by": BASE_ANNOTATION})
...
@kopf.on.delete("", "v1", "configmaps", labels={"app.kubernetes.io/managed-by": BASE_ANNOTATION})
